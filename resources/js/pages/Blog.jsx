...
export default () => {
    ...
    <nav className="w-full py-4 border-t border-b bg-gray-100" >
        <div className="block sm:hidden">
            <a href="#" className="block md:hidden text-base font-bold uppercase text-center flex justify-center items-center">
            Topics <i className="fa-chevron-down fas ml-2"></i>
            </a>
        </div>
        <div className=" open w-full flex-grow sm:flex sm:items-center sm:w-auto">
    ...
    <footer className="w-full border-t bg-white pb-12">
        <div className="relative w-full flex items-center invisible md:visible md:pb-12">
            ...
            <img className="w-1/6 hover:opacity-75" src="https://source.unsplash.com/collection/1346951/800x800?sig=1"/>
            <img className="w-1/6 hover:opacity-75" src="https://source.unsplash.com/collection/1346951/800x800?sig=1"/>
            <img className="w-1/6 hover:opacity-75" src="https://source.unsplash.com/collection/1346951/800x800?sig=1"/>
            <img className="w-1/6 hover:opacity-75" src="https://source.unsplash.com/collection/1346951/800x800?sig=1"/>
            <img className="w-1/6 hover:opacity-75" src="https://source.unsplash.com/collection/1346951/800x800?sig=1"/>
