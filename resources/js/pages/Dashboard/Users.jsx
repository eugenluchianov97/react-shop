                                ...
                                <div className="col-12">
                                    <div className="preview-list">
                                        <div className="preview-item border-bottom">
                                            ...
                                            <div className="preview-item-content d-sm-flex flex-grow">
                                                <div className="flex-grow">
                                                    <h6 className="preview-subject">Admin dashboard
                                                        design</h6>
                                                    <p className="text-muted mb-0">Broadcast web app
                                                        mockup</p>
                                                </div>
                                        ...
                                        <div className="preview-item border-bottom">
                                            ...
                                            <div className="preview-item-content d-sm-flex flex-grow">
                                                <div className="flex-grow">
                                                    <h6 className="preview-subject">Wordpress
                                                        Development</h6>
                                        ...
                                        <div className="preview-item border-bottom">
                                            ...
                                            <div className="preview-item-content d-sm-flex flex-grow">
                                                <div className="flex-grow">
                                                    ...
                                                    <p className="text-muted mb-0">New project
                                                        discussion</p>
                                                </div>
                                                <div className="me-auto text-sm-right pt-2 pt-sm-0">
                                        ...
                                        <div className="preview-item border-bottom">
                                            ...
                                            <div className="preview-item-content d-sm-flex flex-grow">
                                                <div className="flex-grow">
                                                    ...
                                                    <p className="text-muted mb-0">Sent release details to
                                                        team</p>
                                                </div>
                                                <div className="me-auto text-sm-right pt-2 pt-sm-0">
                                        ...
                                        <div className="preview-item">
                                            ...
                                            <div className="preview-item-content d-sm-flex flex-grow">
                                                <div className="flex-grow">
                                                    ...
                                                    <p className="text-muted mb-0">New application
                                                        planning</p>
                                                </div>
                                                <div className="me-auto text-sm-right pt-2 pt-sm-0">
                                ...
                                <div className="preview-item border-bottom">
                                    ...
                                    <div className="preview-item-content d-flex flex-grow">
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-muted">Thanks a lot. It was easy to fix it
                                                .</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="preview-item p-0">
                                        ...
                                        <div className="preview-item-content d-flex flex-grow">
                                            <div className="flex-grow">
                                                ...
                                                <p className="text-muted">Well, it seems to be working
                                                    now.</p>
                                            </div>
                                        </div>
                                    </div>
